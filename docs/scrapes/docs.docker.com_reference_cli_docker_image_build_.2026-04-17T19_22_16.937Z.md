...
[Home](https://docs.docker.com/)/ [Reference](https://docs.docker.com/reference/)/ [CLI reference](https://docs.docker.com/reference/cli/docker/image/build/)/ [docker](https://docs.docker.com/reference/cli/docker/)/ [docker image](https://docs.docker.com/reference/cli/docker/image/)/docker image build
...
| Aliases<br>An alias is a short or memorable alternative for a longer command. | `docker build``docker builder build` |

## [Description](https://docs.docker.com/reference/cli/docker/image/build/\#description)
...
### [Build context with the legacy builder](https://docs.docker.com/reference/cli/docker/image/build/\#build-context-with-the-legacy-builder)
...
#### [Accessing paths outside the build context](https://docs.docker.com/reference/cli/docker/image/build/\#accessing-paths-outside-the-build-context)
...
## [Options](https://docs.docker.com/reference/cli/docker/image/build/\#options)
...
| [`--isolation`](https://docs.docker.com/reference/cli/docker/image/build/#isolation) |  | Container isolation technology |
| `--label` |  | Set metadata for an image |
| `-m, --memory` |  | Memory limit |
| `--memory-swap` |  | Swap limit equal to memory plus swap: -1 to enable unlimited swap |
| [`--network`](https://docs.docker.com/reference/cli/docker/buildx/build/#network) |  | API 1.25+<br>Set the networking mode for the RUN instructions during build |
| `--no-cache` |  | Do not use cache when building the image |
| `--platform` |  | API 1.38+<br>Set platform if server is multi-platform capable |
| `--pull` |  | Always attempt to pull a newer version of the image |
| `-q, --quiet` |  | Suppress the build output and print image ID on success |
| `--rm` | `true` | Remove intermediate containers after a successful build |
| [`--security-opt`](https://docs.docker.com/reference/cli/docker/image/build/#security-opt) |  | Security options |
| `--shm-size` |  | Size of `/dev/shm` |
| [`--squash`](https://docs.docker.com/reference/cli/docker/image/build/#squash) |  | API 1.25+<br>experimental (daemon)<br>Squash newly built layers into a single new layer |
...
## [Examples](https://docs.docker.com/reference/cli/docker/image/build/\#examples)

### [Specify isolation technology for container (--isolation)](https://docs.docker.com/reference/cli/docker/image/build/\#isolation)
...
### [Optional security options (--security-opt)](https://docs.docker.com/reference/cli/docker/image/build/\#security-opt)

This flag is only supported on a daemon running on Windows, and only supports
the `credentialspec` option. The `credentialspec` must be in the format
`file://spec.txt` or `registry://keyname`.

### [Squash an image's layers (--squash) (experimental)](https://docs.docker.com/reference/cli/docker/image/build/\#squash)

#### [Overview](https://docs.docker.com/reference/cli/docker/image/build/\#overview)
...
#### [Known limitations](https://docs.docker.com/reference/cli/docker/image/build/\#known-limitations)
...
#### [Prerequisites](https://docs.docker.com/reference/cli/docker/image/build/\#prerequisites)
...
#### [Build an image with the `--squash` flag](https://docs.docker.com/reference/cli/docker/image/build/\#build-an-image-with-the---squash-flag)
