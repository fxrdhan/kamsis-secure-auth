...
<head>
    ...
    <title>iptables(8) - Linux manual page</title>
...
<!--%%%PAGE_START%%%-->
<h1>iptables(8) &mdash; Linux manual page</h1>
...
<tr>
    <td>
        <p class="section-dir">
<a href="#NAME">NAME</a> | <a href="#SYNOPSIS">SYNOPSIS</a> | <a href="#DESCRIPTION">DESCRIPTION</a> | <a href="#TARGETS">TARGETS</a> | <a href="#TABLES">TABLES</a> | <a href="#OPTIONS">OPTIONS</a> | <a href="#LOCK_FILE">LOCK&nbsp;FILE</a> | <a href="#MATCH_AND_TARGET_EXTENSIONS">MATCH&nbsp;AND&nbsp;TARGET&nbsp;EXTENSIONS</a> | <a href="#DIAGNOSTICS">DIAGNOSTICS</a> | <a href="#BUGS">BUGS</a> | <a href="#COMPATIBILITY_WITH_IPCHAINS">COMPATIBILITY&nbsp;WITH&nbsp;IPCHAINS</a> | <a href="#SEE_ALSO">SEE&nbsp;ALSO</a> | <a href="#AUTHORS">AUTHORS</a> | <a href="#VERSION">VERSION</a> | <a href="#COLOPHON">COLOPHON</a>
        </p>
    </td>
</tr>
<tr>
...
<!--%%%TEXT_START%%%-->
<pre>
<span class="headline"><i>IPTABLES</i>(8)                  iptables 1.8.11                  <i>IPTABLES</i>(8)</span>
</pre>
...
<h2><a id="TARGETS" href="#TARGETS"></a>TARGETS  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
       ...
       the targets described in <a href="../man8/iptables-extensions.8.html">iptables-extensions(8)</a>, or one of the
...
<h2><a id="TABLES" href="#TABLES"></a>TABLES  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
       ...
       <b>-t</b>, <b>--table </b><i>table</i>
              ...
              <b>nat</b>:
                  ...
                  they come in), <b>INPUT </b>(for altering packets destined for
                  local sockets), <b>OUTPUT </b>(for altering locally-generated
                  packets before routing), and <b>POSTROUTING </b>(for altering
...
<h2><a id="OPTIONS" href="#OPTIONS"></a>OPTIONS  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
   ...
   <b>COMMANDS</b>
       ...
       to use only enough letters to ensure that <b>iptables </b>can
       ...
       <b>-L</b>, <b>--list </b>[<i>chain</i>]
              ...
              rules are suppressed until you use
               iptables -L -v
              or <a href="../man8/iptables-save.8.html">iptables-save(8)</a>.
       ...
       <b>-X</b>, <b>--delete-chain </b>[<i>chain</i>]
              ...
              Empty builtin chains can only be deleted with <b>iptables-nft</b>.

       <b>-P</b>, <b>--policy </b><i>chain target</i>
              Set the policy for the built-in (non-user-defined) chain to
              the given target.  The policy target must be either <b>ACCEPT</b>
              or <b>DROP</b>.
   ...
   <b>PARAMETERS</b>
       ...
       <b>-4</b>, <b>--ipv4</b>
              ...
              If a rule using the <b>-4 </b>option is inserted with (and only
              with) <b>ip6tables-restore</b>, it will be silently ignored. Any
       ...
       [<b>!</b>] <b>-p</b>, <b>--protocol </b><i>protocol</i>
              ...
              to <b>all</b>. "<b>all</b>" will match with all protocols and is taken as
              ...
              it were the last, you cannot use <b>-p 0</b>, but always need <b>-m</b>
              <b>hbh</b>.

       [<b>!</b>] <b>-s</b>, <b>--source </b><i>address</i>[<b>/</b><i>mask</i>][<b>,</b><i>...</i>]
              Source specification. <i>Address</i> can be either a network name,
              a hostname, a network IP address (with <b>/</b><i>mask</i>), or a plain
              ...
              as DNS is a really bad idea.  The <i>mask</i> can be either an
              ipv4 network mask (for iptables) or a plain number,
              specifying the number of 1's at the left side of the
              network mask.  Thus, an iptables mask of <i>24</i> is equivalent
              to <i>255.255.255.0</i>.  A "!" argument before the address
              specification inverts the sense of the address. The flag
              <b>--src </b>is an alias for this option.  Multiple addresses can
              be specified, but this will <b>expand to multiple rules </b>(when
       ...
       <b>-j</b>, <b>--jump </b><i>target</i>
              ...
              immediately, or an extension (see <b>MATCH AND TARGET</b>
       ...
       <b>-g</b>, <b>--goto </b><i>chain</i>
              ...
              user specified chain. Unlike with the --jump option, <b>RETURN</b>
       ...
       [<b>!</b>] <b>-o</b>, <b>--out-interface </b><i>name</i>
              ...
              (for packets entering the <b>FORWARD</b>, <b>OUTPUT </b>and <b>POSTROUTING</b>
              chains).  When the "!" argument is used before the
              interface name, the sense is inverted.  If the interface
              name ends in a "+", then any interface which begins with
              this name will match.  If this option is omitted, any
       ...
       <b>-c</b>, <b>--set-counters </b><i>packets bytes</i>
              ...
              byte counters of a rule (during <b>INSERT</b>, <b>APPEND</b>, <b>REPLACE</b>
              operations).
   ...
   <b>OTHER OPTIONS</b>
       ...
       <b>-v</b>, <b>--verbose</b>
              ...
              1,000,000,000 multipliers respectively (but see the <b>-x </b>flag
              ...
              twice, <b>iptables-legacy </b>will dump table info and entries in
              libiptc, <b>iptables-nft </b>dumps rules in netlink (VM code)
              presentation.  Specified three times, <b>iptables-nft </b>will
       ...
       <b>-w</b>, <b>--wait </b>[<i>seconds</i>]
              ...
              optional <i>seconds</i>) until the exclusive lock can be obtained.
       ...
       <b>--modprobe=</b><i>command</i>
              When adding or inserting rules into a chain, use <i>command</i> to
              load any necessary modules (targets, match extensions,
              etc).

       <b>--compat </b>(nft-variants only)
              ...
              The <b>XTABLES_COMPAT </b>environment variable can be used to
              override the default setting. The expected value is a
              natural number representing the number of times <b>--compat</b>
              was specified.
</pre>
<h2><a id="LOCK_FILE" href="#LOCK_FILE"></a>LOCK FILE  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
       iptables uses the <i>/run/xtables.lock</i> file to take an exclusive lock
       at launch.

       The <b>XTABLES_LOCKFILE </b>environment variable can be used to override
       the default setting.
</pre>
<h2><a id="MATCH_AND_TARGET_EXTENSIONS" href="#MATCH_AND_TARGET_EXTENSIONS"></a>MATCH AND TARGET EXTENSIONS  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
       iptables can use extended packet matching and target modules.  A
       list of these is available in the <a href="../man8/iptables-extensions.8.html">iptables-extensions(8)</a> manpage.
</pre>
...
<h2><a id="COMPATIBILITY_WITH_IPCHAINS" href="#COMPATIBILITY_WITH_IPCHAINS"></a>COMPATIBILITY WITH IPCHAINS  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
...
<h2><a id="SEE_ALSO" href="#SEE_ALSO"></a>SEE ALSO  &nbsp; &nbsp; &nbsp; &nbsp; <a href="#top_of_page"><span class="top-link">top</span></a></h2><pre>
       <a href="../man8/iptables-apply.8.html">iptables-apply(8)</a>, <a href="../man8/iptables-save.8.html">iptables-save(8)</a>, <a href="../man8/iptables-restore.8.html">iptables-restore(8)</a>,
       <a href="../man8/iptables-extensions.8.html">iptables-extensions(8)</a>,
...
<span class="footline">iptables 1.8.11                                               <i>IPTABLES</i>(8)</span>
</pre>

<hr class="end-man-text" />
<p>Pages that refer to this page:
    <a href="../man1/iptables-xml.1.html">iptables-xml(1)</a>,&nbsp;
    ...
    <a href="../man8/arptables-nft.8.html">arptables-nft(8)</a>,&nbsp;
    <a href="../man8/ebtables-nft.8.html">ebtables-nft(8)</a>,&nbsp;
    <a href="../man8/flowtop.8.html">flowtop(8)</a>,&nbsp;
    <a href="../man8/ifconfig.8.html">ifconfig(8)</a>,&nbsp;
    <a href="../man8/ip-link.8.html">ip-link(8)</a>,&nbsp;
    <a href="../man8/iptables-apply.8.html">iptables-apply(8)</a>,&nbsp;
    <a href="../man8/iptables-restore.8.html">iptables-restore(8)</a>,&nbsp;
    <a href="../man8/iptables-save.8.html">iptables-save(8)</a>,&nbsp;
    <a href="../man8/mountd.8.html">mountd(8)</a>,&nbsp;
    <a href="../man8/netstat.8.html">netstat(8)</a>,&nbsp;
    <a href="../man8/ovs-ctl.8.html">ovs-ctl(8)</a>,&nbsp;
    <a href="../man8/statd.8.html">statd(8)</a>,&nbsp;
    <a href="../man8/tc-bpf.8.html">tc-bpf(8)</a>,&nbsp;
    <a href="../man8/tc-fw.8.html">tc-fw(8)</a>,&nbsp;
    <a href="../man8/tc-mqprio.8.html">tc-mqprio(8)</a>,&nbsp;
    <a href="../man8/wg-quick.8.html">wg-quick(8)</a>,&nbsp;
    <a href="../man8/xtables-monitor.8.html">xtables-monitor(8)</a>,&nbsp;
    <a href="../man8/xtables-nft.8.html">xtables-nft(8)</a>,&nbsp;
    <a href="../man8/xtables-translate.8.html">xtables-translate(8)</a>
</p>
<hr/>
