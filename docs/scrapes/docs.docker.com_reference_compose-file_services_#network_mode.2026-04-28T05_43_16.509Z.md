...
- `condition`: Sets the condition under which dependency is considered satisfied
  ...
  - `service_healthy`: Specifies that a dependency is expected to be "healthy"
    (as indicated by [`healthcheck`](https://docs.docker.com/reference/compose-file/services/#healthcheck)) before starting a dependent
    service.
...
Environment variables declared in the [`environment`](https://docs.docker.com/reference/compose-file/services/#environment) section override these values. This holds true even if those values are
empty or undefined.
...
#### [`required`](https://docs.docker.com/reference/compose-file/services/\#required)
...
### [`gpus`](https://docs.docker.com/reference/compose-file/services/\#gpus)
...
### [`label_file`](https://docs.docker.com/reference/compose-file/services/\#label_file)
...
[`depends_on`](https://docs.docker.com/reference/compose-file/services/#depends_on), so they determine the order of service startup.
...
> Note
>
> Container runtimes might reject this value, for example Docker Engine >= v25.0. In that case, you should use [networks.mac\_address](https://docs.docker.com/reference/compose-file/services/#mac_address) instead.
...
### [`models`](https://docs.docker.com/reference/compose-file/services/\#models)
...
When set, the [`networks`](https://docs.docker.com/reference/compose-file/services/#networks) attribute is not allowed and Compose rejects any
...
#### [`driver_opts`](https://docs.docker.com/reference/compose-file/services/\#driver_opts-1)
...
#### [`gw_priority`](https://docs.docker.com/reference/compose-file/services/\#gw_priority)
...
[`gw_priority`](https://docs.docker.com/reference/compose-file/services/#gw_priority) attribute instead.
...
> Warning
>
> If you do not specify a host IP (such as `127.0.0.1`), Docker binds to all interfaces (`0.0.0.0`), bypassing host firewall rules. This can expose the container directly to the internet if the host has a public IP address. For more information, see
...
Configuration is equivalent to [post\_start](https://docs.docker.com/reference/compose-file/services/#post_start).
...
### [`provider`](https://docs.docker.com/reference/compose-file/services/\#provider)
...
#### [`type`](https://docs.docker.com/reference/compose-file/services/\#type)

`type` attribute is required. It defines the external component used by Compose to manage setup and tear down lifecycle
events.

#### [`options`](https://docs.docker.com/reference/compose-file/services/\#options)
...
[`stop_signal`](https://docs.docker.com/reference/compose-file/services/#stop_signal)), before sending SIGKILL. It's specified
...
#### [Long syntax](https://docs.docker.com/reference/compose-file/services/\#long-syntax-6)
