...
volume, use the `volume-nocopy` option, see [Options for --mount](https://docs.docker.com/engine/storage/volumes/#options-for---mount).
...
## [Syntax](https://docs.docker.com/engine/storage/volumes/\#syntax)
