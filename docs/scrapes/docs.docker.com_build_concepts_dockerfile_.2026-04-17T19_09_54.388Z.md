...
- [Explore](https://docs.docker.com/dhi/explore/)
  ...
  - [Malware scanning](https://docs.docker.com/dhi/explore/malware-scanning/ "Malware scanning")
...
[Home](https://docs.docker.com/)/ [Manuals](https://docs.docker.com/manuals/)/ [Docker Build](https://docs.docker.com/build/)/ [Core concepts](https://docs.docker.com/build/concepts/dockerfile/)/Dockerfile overview
...
[`# syntax` parser directive](https://docs.docker.com/reference/dockerfile/#syntax).
...
The
[`FROM` instruction](https://docs.docker.com/reference/dockerfile/#from) sets your base
...
This
[`RUN` instruction](https://docs.docker.com/reference/dockerfile/#run) executes a
...
> [syntax directive](https://docs.docker.com/build/concepts/dockerfile/#dockerfile-syntax) on the first line of the file.
...
The
[`EXPOSE` instruction](https://docs.docker.com/reference/dockerfile/#expose) marks that
...
Finally,
[`CMD` instruction](https://docs.docker.com/reference/dockerfile/#cmd) sets the
...
[previous section](https://docs.docker.com/build/concepts/dockerfile/#example), you use the `docker build` command:
