[Skip to Main Content](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#main)

[Hide Sidebar](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "Hide Sidebar")

[Previous: CREATE ROLE Statement](https://dev.mysql.com/doc/refman/8.4/en/create-role.html "Previous: CREATE ROLE Statement")[Start](https://dev.mysql.com/doc/refman/8.4/en/index.html "Start")[Up: Account Management Statements](https://dev.mysql.com/doc/refman/8.4/en/account-management-statements.html "Up: Account Management Statements")[Next: DROP ROLE Statement](https://dev.mysql.com/doc/refman/8.4/en/drop-role.html "Next: DROP ROLE Statement")
...
[Related Documentation](https://dev.mysql.com/doc/refman/8.4/en/create-user.html)

[MySQL 8.4 Release Notes](https://dev.mysql.com/doc/relnotes/mysql/8.4/en/)

[Download\\
this Manual](https://dev.mysql.com/doc/refman/8.4/en/create-user.html)
...
[version 8.4](https://dev.mysql.com/doc/refman/8.4/en/create-user.html)

[9.7\\
current](https://dev.mysql.com/doc/refman/9.7/en/create-user.html)

[9.6](https://dev.mysql.com/doc/refman/9.6/en/create-user.html)

[9.5](https://dev.mysql.com/doc/refman/9.5/en/create-user.html)
...
[Show Sidebar](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "Show Sidebar")

[MySQL 8.4 Reference Manual](https://dev.mysql.com/doc/refman/8.4/en/)  /
[...](https://dev.mysql.com/doc/refman/8.4/en/create-user.html)  / [SQL Statements](https://dev.mysql.com/doc/refman/8.4/en/sql-statements.html)  /
...
The [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") statement creates
...
To use [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement"), you must have
the global [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_create-user) privilege,
or the [`INSERT`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_insert) privilege for the
...
enabled, [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") additionally
...
- The [`authentication_policy`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_authentication_policy)
system variable places certain constraints on how the
authentication-related clauses of
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") statements may be
used; for details, see the description of that variable.
These constraints do not apply if you have the
[`AUTHENTICATION_POLICY_ADMIN`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_authentication-policy-admin)
privilege.


- To create an account that uses passwordless authentication,
you must have the
[`PASSWORDLESS_USER_ADMIN`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_passwordless-user-admin)
privilege.


[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") fails with an error
...
[`SET_ANY_DEFINER`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_set-any-definer) or
[`ALLOW_NONEXISTENT_DEFINER`](https://dev.mysql.com/doc/refman/8.4/en/privileges-provided.html#priv_allow-nonexistent-definer)
...
[Orphan Stored Objects](https://dev.mysql.com/doc/refman/8.4/en/stored-objects-security.html#stored-objects-security-orphan-objects "Orphan Stored Objects").


[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") either succeeds for
...
Under some circumstances, [`CREATE\\
          USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") may be recorded in server logs or on the client
...
it, see [Section 8.1.2.3, “Passwords and Logging”](https://dev.mysql.com/doc/refman/8.4/en/password-logging.html "8.1.2.3 Passwords and Logging"). For similar
...
There are several aspects to the [`CREATE\\
        USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") statement, described under the following topics:

- [CREATE USER Overview](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-overview "CREATE USER Overview")

- [CREATE USER Authentication Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-authentication "CREATE USER Authentication Options")

- [CREATE USER Multifactor Authentication Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-multifactor-authentication "CREATE USER Multifactor Authentication Options")

- [CREATE USER Role Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-role "CREATE USER Role Options")

- [CREATE USER SSL/TLS Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-tls "CREATE USER SSL/TLS Options")

- [CREATE USER Resource-Limit Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-resource-limits "CREATE USER Resource-Limit Options")

- [CREATE USER Password-Management Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-password-management "CREATE USER Password-Management Options")

- [CREATE USER Comment and Attribute Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-comments-attributes "CREATE USER Comment and Attribute Options")

- [CREATE USER Account-Locking Options](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-account-locking "CREATE USER Account-Locking Options")

- [CREATE USER Binary Logging](https://dev.mysql.com/doc/refman/8.4/en/create-user.html#create-user-binary-logging "CREATE USER Binary Logging")


##### CREATE USER Overview

For each account, [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement")
...
[The Default Authentication Plugin](https://dev.mysql.com/doc/refman/8.4/en/pluggable-authentication.html#pluggable-authentication-default-plugin "The Default Authentication Plugin")),
...
[`GRANT`](https://dev.mysql.com/doc/refman/8.4/en/grant.html "15.7.1.6 GRANT Statement") statements.


Each account name uses the format described in
[Section 8.2.4, “Specifying Account Names”](https://dev.mysql.com/doc/refman/8.4/en/account-names.html "8.2.4 Specifying Account Names"). For example:
...
[Section 8.2.15, “Password Management”](https://dev.mysql.com/doc/refman/8.4/en/password-management.html "8.2.15 Password Management").
...
[Section 8.4.1, “Authentication Plugins”](https://dev.mysql.com/doc/refman/8.4/en/authentication-plugins.html "8.4.1 Authentication Plugins").
...
respectively:
  ...
  - For syntax that uses `BY RANDOM
     ...
     described in
     [Random Password Generation](https://dev.mysql.com/doc/refman/8.4/en/password-management.html#random-password-generation "Random Password Generation").
  ...
  - For syntax that uses `AS
     ...
     of value displayed by [`SHOW CREATE\\
                      USER`](https://dev.mysql.com/doc/refman/8.4/en/show-create-user.html "15.7.7.13 SHOW CREATE USER Statement") for password hashes containing
     unprintable characters when the
     [`print_identified_with_as_hex`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_print_identified_with_as_hex)
...
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") permits these
...
[Section 8.2.14, “Assigning Account Passwords”](https://dev.mysql.com/doc/refman/8.4/en/assigning-passwords.html "8.2.14 Assigning Account Passwords"), and
...
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") defines an
authentication method for one-factor/single-factor
authentication (1FA/SFA). [`CREATE\\
          USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") also supports multifactor authentication (MFA),
...
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") statements with
multifactor authentication (MFA) clauses. For example, the
[`authentication_policy`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_authentication_policy) setting
controls the number of authentication factors that accounts
may have, and for each factor, which authentication methods
are permitted. See
[Configuring the Multifactor Authentication Policy](https://dev.mysql.com/doc/refman/8.4/en/multifactor-authentication.html#multifactor-authentication-policy "Configuring the Multifactor Authentication Policy").
...
See
[WebAuthn Passwordless Authentication](https://dev.mysql.com/doc/refman/8.4/en/webauthn-pluggable-authentication.html#webauthn-pluggable-authentication-passwordless "WebAuthn Passwordless Authentication").
...
[`SET ROLE\\
          DEFAULT`](https://dev.mysql.com/doc/refman/8.4/en/set-role.html "15.7.1.11 SET ROLE Statement") statement during a session.


Each role name uses the format described in
[Section 8.2.5, “Specifying Role Names”](https://dev.mysql.com/doc/refman/8.4/en/role-names.html "8.2.5 Specifying Role Names"). For example:
...
at the time [`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") is
executed; otherwise the statement raises an error
( [`ER_USER_DOES_NOT_EXIST`](https://dev.mysql.com/doc/mysql-errors/8.4/en/server-error-reference.html#error_er_user_does_not_exist)), and
...
with MySQL, see [Section 8.3, “Using Encrypted Connections”](https://dev.mysql.com/doc/refman/8.4/en/encrypted-connections.html "8.3 Using Encrypted Connections").
...
[`--ssl-mode=REQUIRED`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-mode)
...
must specify the [`--ssl-key`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-key)
and [`--ssl-cert`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-cert) options to
connect. (It is recommended but not required that
[`--ssl-ca`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-ca) also be specified
...
[`--ssl-key`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-key) and
[`--ssl-cert`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-cert) options to
connect. (It is recommended but not required that
[`--ssl-ca`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-ca) also be specified
so that the public certificate provided by the server can
be verified.)
...
specify the [`--ssl-key`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-key) and
[`--ssl-cert`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-cert) options to
connect. (It is recommended but not required that
[`--ssl-ca`](https://dev.mysql.com/doc/refman/8.4/en/connection-options.html#option_general_ssl-ca) also be specified
so that the public certificate provided by the server can
...
an account, as discussed in [Section 8.2.21, “Setting Account Resource Limits”](https://dev.mysql.com/doc/refman/8.4/en/user-resources.html "8.2.21 Setting Account Resource Limits").
...
value of the
[`max_user_connections`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_max_user_connections)
system variable. If
[`max_user_connections`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_max_user_connections) is
...
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") supports several
...
[Section 8.2.16, “Server Handling of Expired Passwords”](https://dev.mysql.com/doc/refman/8.4/en/expired-password-handling.html "8.2.16 Server Handling of Expired Passwords")). Operations
...
[`default_password_lifetime`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_default_password_lifetime)
system variable.
...
specified by the
[`password_history`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_password_history) system
variable.
...
by the
[`password_reuse_interval`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_password_reuse_interval)
system variable.
...
specified by the
[`password_require_current`](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_password_require_current)
system variable.
...
[Failed-Login Tracking and Temporary Account Locking](https://dev.mysql.com/doc/refman/8.4/en/password-management.html#failed-login-tracking "Failed-Login Tracking and Temporary Account Locking").
...
[`USER_ATTRIBUTES`](https://dev.mysql.com/doc/refman/8.4/en/information-schema-user-attributes-table.html "28.3.45 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table. This query
...
[`USER_ATTRIBUTES`](https://dev.mysql.com/doc/refman/8.4/en/information-schema-user-attributes-table.html "28.3.45 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table:
...
option with an [`ALTER USER`](https://dev.mysql.com/doc/refman/8.4/en/alter-user.html "15.7.1.1 ALTER USER Statement")
statement.


Because the user comment and user attribute are stored
together internally in a single
[`JSON`](https://dev.mysql.com/doc/refman/8.4/en/json.html "13.5 The JSON Data Type") column, this sets an upper
limit on their maximum combined size; see
[JSON Storage Requirements](https://dev.mysql.com/doc/refman/8.4/en/storage-requirements.html#data-types-storage-reqs-json "JSON Storage Requirements"), for more
information.


See also the description of the Information Schema
[`USER_ATTRIBUTES`](https://dev.mysql.com/doc/refman/8.4/en/information-schema-user-attributes-table.html "28.3.45 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table for more
...
[Section 8.2.20, “Account Locking”](https://dev.mysql.com/doc/refman/8.4/en/account-locking.html "8.2.20 Account Locking").
...
[`CREATE USER`](https://dev.mysql.com/doc/refman/8.4/en/create-user.html "15.7.1.3 CREATE USER Statement") is written to the
