[Skip to content](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#content-security-policy-cheat-sheet)
...
Cheatsheets
  ...
  - [ ]
    ...
    - [Introduction](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#introduction)
    - [Context](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#context)

      - [Defense against XSS](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#defense-against-xss)

        - [1\. Restricting Inline Scripts](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#1-restricting-inline-scripts)
        - [2\. Restricting Remote Scripts](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#2-restricting-remote-scripts)
        - [3\. Restricting Unsafe JavaScript](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#3-restricting-unsafe-javascript)
        - [4\. Restricting Form submissions](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#4-restricting-form-submissions)
        - [5\. Restricting Objects](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#5-restricting-objects)

      - [Defense against framing attacks](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#defense-against-framing-attacks)
      - [Defense in Depth](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#defense-in-depth)

    - [Policy Delivery](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#policy-delivery)

      - [1\. Content-Security-Policy Header](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#1-content-security-policy-header)
      - [2\. Content-Security-Policy-Report-Only Header](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#2-content-security-policy-report-only-header)
      - [3\. Content-Security-Policy Meta Tag](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#3-content-security-policy-meta-tag)
      - [WARNING](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#warning)

    - [CSP Types (granular/allowlist based or strict)](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#csp-types-granularallowlist-based-or-strict)
    - [Strict CSP](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#strict-csp)

      - [Nonce based](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#nonce-based)

        - [Warning](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#warning_1)

      - [Hashes](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#hashes)

        - [Note](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#note)

      - [strict-dynamic](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#strict-dynamic)

    - [Detailed CSP Directives](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#detailed-csp-directives)

      - [Fetch Directives](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#fetch-directives)
      - [Document Directives](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#document-directives)
      - [Navigation Directives](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#navigation-directives)
      - [Reporting Directives](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#reporting-directives)
      - [Special Directive Sources](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#special-directive-sources)

    - [CSP Sample Policies](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#csp-sample-policies)

      - [Strict Policy](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#strict-policy)

        - [Nonce-based Strict Policy](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#nonce-based-strict-policy)
        - [Hash-based Strict Policy](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#hash-based-strict-policy)

      - [Basic non-Strict CSP Policy](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#basic-non-strict-csp-policy)
      - [Upgrading insecure requests](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#upgrading-insecure-requests)
      - [Preventing framing attacks (clickjacking, cross-site leaks)](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#preventing-framing-attacks-clickjacking-cross-site-leaks)
      - [Refactoring inline code](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#refactoring-inline-code)

    - [References](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#references)
...
# Content Security Policy Cheat Sheet [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#content-security-policy-cheat-sheet "Permanent link")

## Introduction [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#introduction "Permanent link")
...
## Context [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#context "Permanent link")
...
### Defense against XSS [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#defense-against-xss "Permanent link")

CSP defends against XSS attacks in the following ways:

#### 1\. Restricting Inline Scripts [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#1-restricting-inline-scripts "Permanent link")
...
#### 2\. Restricting Remote Scripts [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#2-restricting-remote-scripts "Permanent link")
...
#### 3\. Restricting Unsafe JavaScript [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#3-restricting-unsafe-javascript "Permanent link")
...
#### 4\. Restricting Form submissions [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#4-restricting-form-submissions "Permanent link")
...
#### 5\. Restricting Objects [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#5-restricting-objects "Permanent link")
...
### Defense against framing attacks [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#defense-against-framing-attacks "Permanent link")
...
### Defense in Depth [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#defense-in-depth "Permanent link")
...
## Policy Delivery [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#policy-delivery "Permanent link")

You can deliver a Content Security Policy to your website in three ways.

### 1\. Content-Security-Policy Header [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#1-content-security-policy-header "Permanent link")
...
### 2\. Content-Security-Policy-Report-Only Header [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#2-content-security-policy-report-only-header "Permanent link")
...
### 3\. Content-Security-Policy Meta Tag [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#3-content-security-policy-meta-tag "Permanent link")
...
### WARNING [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#warning "Permanent link")
...
## CSP Types (granular/allowlist based or strict) [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#csp-types-granularallowlist-based-or-strict "Permanent link")
...
## Strict CSP [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#strict-csp "Permanent link")

A strict CSP can be created by using a limited number of the granular [Fetch Directives listed below](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html#fetch-directives) along with one of two mechanisms:
...
### Nonce based [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#nonce-based "Permanent link")
...
#### Warning [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#warning_1 "Permanent link")
...
### Hashes [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#hashes "Permanent link")
...
#### Note [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#note "Permanent link")
...
### strict-dynamic [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#strict-dynamic "Permanent link")
...
## Detailed CSP Directives [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#detailed-csp-directives "Permanent link")
...
### Fetch Directives [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#fetch-directives "Permanent link")
...
### Document Directives [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#document-directives "Permanent link")
...
### Navigation Directives [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#navigation-directives "Permanent link")
...
### Reporting Directives [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#reporting-directives "Permanent link")
...
### Special Directive Sources [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#special-directive-sources "Permanent link")
...
## CSP Sample Policies [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#csp-sample-policies "Permanent link")

### Strict Policy [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#strict-policy "Permanent link")
...
#### Nonce-based Strict Policy [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#nonce-based-strict-policy "Permanent link")
...
#### Hash-based Strict Policy [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#hash-based-strict-policy "Permanent link")
...
### Basic non-Strict CSP Policy [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#basic-non-strict-csp-policy "Permanent link")
...
### Upgrading insecure requests [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#upgrading-insecure-requests "Permanent link")
...
### Preventing framing attacks (clickjacking, cross-site leaks) [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#preventing-framing-attacks-clickjacking-cross-site-leaks "Permanent link")
...
### Refactoring inline code [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#refactoring-inline-code "Permanent link")
...
## References [¶](https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html\#references "Permanent link")
